...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <form id="formAccountSettings" method="POST" action="{{ route('data_karyawans.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" type="text" id="NIK" name="nik" placeholder="NIK" autofocus />
                            </div>
                            <div class="mb-3 col-md-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="NPWP" name="npwp" placeholder="NPWP" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="NoBPJST" name="nbpkt" placeholder="BPJS Ketenagakerjaan" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control" type="date" placeholder="Tanggal Masuk Kerja" name="tmk" id="html5-date-input" />
                                </div>
                            </div>
                            <div class="mb-3 col-md-4">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="GOLJAB" name="gj" placeholder="Golongan Jabatan" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input class="form-control" type="text" id="Uker" name="uk" placeholder="Unit Kerja" autofocus />
                            </div>
                            <div class="mb-3 col-md-3">
                                <label for="AUker" class="form-label">Anaknya Unit Kerja</label>
                                <input class="form-control" type="text" id="AUker" name="auk" placeholder="anaknya Unit Kerja" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input class="form-control" type="text" id="Rek" name="norek" placeholder="no rekening" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="AtNa" class="form-label">Atas Nama</label>
                                <input class="form-control" type="text" id="AtNa" name="an" placeholder="Nama Pemegang Rekening" autofocus />
                            </div>
                            <div class="mb-3 col-md-3">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="col-md-12">
                                    <input name="tb" class="form-control" type="date" id="tb" data-date-inline-picker="true" />
                                </div>
                            </div>
                            </label>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="PhDP" name="phdp" placeholder="PhDP" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="UpahJSMR" class="form-label">Upah JSMR</label>
                                <input class="form-control" type="text" id="UpahJSMR" name="ujsm" placeholder="Upah JSMR" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="PhDA" class="form-label">PhDA</label>
                                <input class="form-control" type="text" id="PhDA" name="phda" placeholder="PhDA" autofocus />
                            </div>
                            <div class="mt-3">
