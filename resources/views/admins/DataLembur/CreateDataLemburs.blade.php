                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        <td><input class="form-control absen text-center" style="border:none" type="text" id="tanggal" name="tanggal" disabled/></td>
                                        <td><input class="form-control absen text-center" style="border:none" type="text" id="jam" name="jam" value="7" disabled/></td>
                                        <td><input class="form-control absen text-center" style="border:none" type="text" id="jenishari" name="jenishari" value="Hari Kerja" disabled/></td>
                    ...
                    <div class="card">
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                    <td><input class="form-control absen text-center" style="border:none" type="text" id="jumlahinsentif" name="jumlahinsentif" value="2" disabled/></td>
                                    <td><input class="form-control absen text-center" style="border:none" type="text" id="rpinsentif" name="rpinsentif" value="10000" disabled/></td>   
                                    <td><input class="form-control absen text-center" style="border:none" type="text" id="totalinsentif" name="totalinsentif" value="20000" disabled /></td>
                                    <td>
                                            <div class="dropdown">
                                                <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                                    <i class="bx bx-dots-vertical-rounded"></i>
