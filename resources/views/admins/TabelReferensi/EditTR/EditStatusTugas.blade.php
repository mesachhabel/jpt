                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="formAccountSettings" method="POST"
                            action="{{ route('statustugas.update', $statustugas->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="row g-2">
                                    <div class="col mb-0">
                                        ...
                                        <input type="text" id="emailWithTitle" class="form-control"
                                            ...
                                            value="{{ old('kode', $statustugas->kode) }}" />
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col mb-0">
                                        ...
                                        <input type="text" id="dobWithTitle" class="form-control"
                                            ...
                                            value="{{ old('uraian', $statustugas->uraian) }}" />
                                    </div>
                                </div>
                                <hr class="my-3" />
                                ...
                                <div class="row mt-2">
                                    <div class="col mb-0">
                                        ...
                                        <input type="text" id="dobWithTitle" class="form-control"
                                            ...
                                            value="{{ old('bank', $statustugas->bank) }}" />
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col mb-0">
                                        ...
                                        <input type="text" id="dobWithTitle" class="form-control"
                                            ...
                                            value="{{ old('norek', $statustugas->norek) }}" />
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col mb-0">
                                        ...
                                        <input type="text" id="dobWithTitle" class="form-control"
                                            ...
                                            value="{{ old('atasnama', $statustugas->atasnama) }}" />
                                    </div>
                                </div>
                                <hr class="my-0" />
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-primary me-2">Save changes</button>
                                    <a href="{{ route('statustugas.index') }}"
