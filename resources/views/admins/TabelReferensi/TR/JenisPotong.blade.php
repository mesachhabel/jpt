...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="mt-3 mb-3">
            ...
            <!-- Modal -->
            <form id="formAccountSettings" method="POST" action="{{ route('admin.add-jenispotong') }}">
                @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt-2">
                                <div class="col mb-0">
                                    <label for="dobWithTitle" class="form-label">Keterangan Potongan Lain</label>
                                    <input type="text" id="dobWithTitle" class="form-control" placeholder="Kode Sub-Unit" name="uraian"/>
                                </div>
                            </div>
                            <hr class="my-3" />
            ...
            <table class="table table-hover">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @foreach ($potongs as $potong)
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $potong->kode }}</strong></td>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $potong->uraian }}</strong></td>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $potong->bank }}</strong></td>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $potong->norek }}</strong></td>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $potong->atasnama }}</strong></td>
                        <td>
