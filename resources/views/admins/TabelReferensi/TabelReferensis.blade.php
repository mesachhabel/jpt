                ...
                <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.show-skalagaji') }}" type="button"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.show-kodestruktur') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.show-kodejabatan') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.show-jenisterima') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.show-jenispotong') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Tabel Keterangan Slip
                                    Gaji</strong></td>
                            <td>
                                <a href="{{ route('admin.show-keteranganslipgaji') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.show-agama') }}" type="button" class="btn btn-sm btn-success"><i
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.edit-nilaibaku') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('view-skalagaji') }}" type="button" class="btn btn-sm btn-secondary"><i
                                        class="bx bx-file"></i></a>
                                <a href="{{ route('admin.edit-penandatangan') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                                <a href="{{ url('delete-skalagaji') }}" type="button" class="btn btn-sm btn-danger"><i
                                        class="bx bx-trash"></i></a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('view-skalagaji') }}" type="button" class="btn btn-sm btn-secondary"><i
                                        class="bx bx-file"></i></a>
                                <a href="{{ route('admin.edit-statuspegawai') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                                <a href="{{ url('delete-skalagaji') }}" type="button" class="btn btn-sm btn-danger"><i
                                        class="bx bx-trash"></i></a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('view-skalagaji') }}" type="button" class="btn btn-sm btn-secondary"><i
                                        class="bx bx-file"></i></a>
                                <a href="{{ route('admin.edit-statustugas') }}" type="button"
                                    class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
                                <a href="{{ url('delete-skalagaji') }}" type="button" class="btn btn-sm btn-danger"><i
                                        class="bx bx-trash"></i></a>
                            </td>
